...
path_root = Path(
    "/mnt/hdd/datasets/chest/CheXpert/ChecXpert-v10/generated_diffusion3_150/",
)
...
paths_class_1 = [
    path_img
    for n, path_img in enumerate((path_root / class_1).iterdir())
    if a <= n < a + num
]
paths_class_2 = [
    path_img
    for n, path_img in enumerate((path_root / class_2).iterdir())
    if b <= n < b + num
]
