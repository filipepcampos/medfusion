...
class GaussianNoiseScheduler(BasicNoiseScheduler):
    def __init__(
        ...
        if betas is not None:
        ...
        ):  # proposed as "quadratic" in https://arxiv.org/abs/2006.11239, used in stable-diffusion
            betas = (
                torch.linspace(
                    beta_start**0.5,
                    beta_end**0.5,
            ...
            raise NotImplementedError(
                f"{schedule_strategy} does is not implemented for {self.__class__}",
            )
    ...
    def estimate_x_t(self, x_0, t, x_T=None):
        ...
        def clipper(b):
            ...
            if tb < 0:
                ...
                return (
                    self.sqrt_alphas_cumprod[tb] * x_0[b]
                    + self.sqrt_one_minus_alphas_cumprod[tb] * x_T[b]
                )

        x_t = torch.stack([clipper(b) for b in range(t.shape[0])])
        return x_t

    def estimate_x_t_prior_from_x_T(
        self,
        x_t,
        t,
        x_T,
        ...
        return self.estimate_x_t_prior_from_x_0(
            x_t,
            t,
            x_0,
            use_log,
    ...
    def estimate_x_t_prior_from_x_0(
        self,
        x_t,
        t,
        x_0,
        ...
        if cold_diffusion:  # see https://arxiv.org/abs/2208.09392
            x_T_est = self.estimate_x_T(
                x_t,
                x_0,
                t,
            )  # or use x_T estimated by UNet if available?
    ...
    def estimate_mean_t(self, x_t, x_0, t):
        ndim = x_t.ndim
        return (
            self.extract(self.posterior_mean_coef1, t, ndim) * x_0
    ...
    def estimate_x_0(self, x_t, x_T, t, clip_x0=True):
        ndim = x_t.ndim
        x_0 = (
            self.extract(self.sqrt_recip_alphas_cumprod, t, ndim) * x_t
    ...
    def estimate_x_T(self, x_t, x_0, t, clip_x0=True):
        ...
        x_0 = self._clip_x_0(x_0) if clip_x0 else x_0
        return (
            self.extract(self.sqrt_recip_alphas_cumprod, t, ndim) * x_t - x_0
