...
st.markdown(
    "Medfusion was trained on the [AIROGS](https://airogs.grand-challenge.org/data-and-challenge/) dataset",
)
...
cond_str = st.radio(
    ...
    ("Yes", "No"),
    index=1,
    help="Conditioned on 'referable glaucoma' or 'no referable glaucoma'",
    horizontal=True,
)
...
def init_pipeline():
    pipeline = DiffusionPipeline.load_from_checkpoint(
        "runs/2022_11_11_175610_eye_diffusion/last.ckpt",
    )
    return pipeline
